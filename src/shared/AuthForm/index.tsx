...
const AuthForm = ({ isLogin }) => {
  ...
  return (
    <form className={styles.register_form}>
      ...
      {!showSecondForm ? (
        <>
          {!isLogin && <input className={styles.form_input} placeholder='ФИО' type='text' />}
          ...
          {!isLogin && <input className={styles.form_input} placeholder='Повторите пароль' type='password' />}
          {!isLogin && (
