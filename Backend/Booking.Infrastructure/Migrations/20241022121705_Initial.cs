        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    path_to_avatar_image = table.Column<string>(type: "text", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    title = table.Column<string>(type: "text", nullable: false),
                    path_to_banner_image = table.Column<string>(type: "text", nullable: false),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("9c1109fd-6e15-4177-8d61-230409444606"), "Число" },
                    { new Guid("e4d610fd-a4b4-4fe7-8544-e01b7a5e45ec"), "Строка" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("0244a017-ddef-409d-9882-07944e295850"), false, false, "User" },
                    { new Guid("229a04f8-30cf-4783-ad51-51ed94c13c1d"), true, false, "Moderator" },
                    { new Guid("9817d280-de5c-4995-85bd-0d5a57d64a1b"), true, true, "Admin" }
                });
